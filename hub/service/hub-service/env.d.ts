/**
 * Environment variables for the `@sderickson/hub-service` package, including inherited variables.
 ...
 */
export interface HubServiceEnvSchema {
    /**
 ...
 */
export declare const typedEnv: HubServiceEnvSchema;
