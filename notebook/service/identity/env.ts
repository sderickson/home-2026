/**
 * Environment variables for the `@sderickson/notebook-identity` package, including inherited variables.
...
export interface NotebookIdentityEnvSchema {
  /**
...
/**
 * `process.env` casted to the `NotebookIdentityEnvSchema` type.
 */
export const typedEnv = (globalThis.process ? process.env : {}) as unknown as NotebookIdentityEnvSchema;
