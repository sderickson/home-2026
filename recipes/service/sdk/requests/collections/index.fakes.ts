...
import { membersListCollectionsHandler } from "./members-list.fake.ts";
// END WORKFLOW AREA
...
import { membersRemoveCollectionsHandler } from "./members-remove.fake.ts";
...
export const collectionsFakeHandlers = [
  ...
  membersRemoveCollectionsHandler,
