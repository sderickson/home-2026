/**
 * Environment variables for the `@vendata/iform-unsplash` package, including inherited variables.
...
export interface IformUnsplashEnvSchema {
  /**
...
/**
 * `process.env` casted to the `IformUnsplashEnvSchema` type.
 */
export const typedEnv = (globalThis.process ? process.env : {}) as unknown as IformUnsplashEnvSchema;
