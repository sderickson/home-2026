/**
 * Environment variables for the `@sderickson/recipes-unsplash` package, including inherited variables.
 ...
 */
export interface RecipesUnsplashEnvSchema {
    /**
...
/**
 * `process.env` casted to the `RecipesUnsplashEnvSchema` type.
 */
export declare const typedEnv: RecipesUnsplashEnvSchema;
