/**
 * Environment variables for the `@sderickson/recipes-identity` package, including inherited variables.
...
export interface RecipesIdentityEnvSchema {
  /**
...
/**
 * `process.env` casted to the `RecipesIdentityEnvSchema` type.
 */
export const typedEnv = (globalThis.process ? process.env : {}) as unknown as RecipesIdentityEnvSchema;
